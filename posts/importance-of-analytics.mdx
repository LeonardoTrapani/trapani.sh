---
title: "The Importance of Analytics at Datapizza: Best Practices and Implementation Strategy"
...
At Datapizza, we believe that analytics should serve as the foundation for every business and startup. While assumptions about customer needs can guide early product development, it is crucial to understand what customers **really** want—not just what they say they want or what we think they should want. As Eric Ries aptly puts it in *The Lean Startup*:
...
![The Lean Startup Cicle](/images/importanceofanalytics/theleanstartupcicle.jpeg)
...
On the frontend, we simply make a post request to our servers every time we want to track something, including all cookies and headers.
